...
class Paysafecard extends IcepayAbstractMethod
{
    const CODE = 'icepay_icpcore_paysafecard';
    const PMCODE = 'PAYSAFECARD';
...
//    protected $transactionBuilder;
    ...
    {
        $list = parent::getIssuerList(Paysafecard::PMCODE);
