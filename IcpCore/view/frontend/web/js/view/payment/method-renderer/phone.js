...
define(
    ...
    function ($, Component, ko, checkoutData, selectPaymentMethodAction) {
        ...
        return Component.extend({
            defaults: {
                template: 'Icepay_IcpCore/payment/phone'
            },

            issuerList: [],

            getCode: function() {
                return 'icepay_icpcore_phone';
            },
            ...
            getPaymentLogoSrc: function() {
                return window.checkoutConfig.payment.icepay.phone.paymentMethodLogoSrc;
            },

            getPaymentMethodDisplayName: function() {
                return window.checkoutConfig.payment.icepay.phone.getPaymentMethodDisplayName;
            },

            initObservable: function () {
                this._super().observe(['selectedIssuer', 'phoneIssuers']);

                this.phoneIssuers = ko.observableArray(window.checkoutConfig.payment.icepay.phone.issuers);
